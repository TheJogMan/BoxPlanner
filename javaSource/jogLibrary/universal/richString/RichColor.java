...
public class RichColor extends Color
{
	...
	private RichColor(int rgb, char characterCode)
	{
		super(rgb);
		this.characterCode = characterCode;
	}
	
	private RichColor(int r, int g, int b, char characterCode)
	{
		super(r, g, b);
		this.characterCode = characterCode;
	}
	
	private RichColor(int r, int g, int b, int a, char characterCode)
	{
		super(r, g, b, a);
		this.characterCode = characterCode;
	}
	...
	{
		if (!(object instanceof RichColor))
			return false;
		RichColor otherColor = (RichColor)object;
